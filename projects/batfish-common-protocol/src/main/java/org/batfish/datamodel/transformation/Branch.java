...
/**
 * A representation of a packet transformation. When the guard matches the input flow, apply the
 * {@link TransformationStep TransformationSteps} and then apply the {@code andThen} {@link
 * Transformation}. When the guard does not match the flow, apply the {@code orElse} {@link
 * Transformation}. Stop upon reaching a {@code null} transformation.
 */
@ParametersAreNonnullByDefault
public final class Branch extends Transformation {
  ...
  public static final class Builder {
    ...
    public Branch build() {
      return new Branch(_guard, _transformationSteps, _andThen, _orElse);
    }
  }
  ...
  @JsonCreator
  private static Branch jsonCreator(
