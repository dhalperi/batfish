...
public class SimpleExtendedAccessListServiceSpecifier implements AccessListServiceSpecifier {
  ...
  public static class Builder {
    ...
    private IntegerSpace _fragmentOffsets;
  ...
  private final IntegerSpace _fragmentOffsets;
  ...
  public AclLineMatchExpr toAclLineMatchExpr(Map<String, ObjectGroup> objectGroups) {
    return new MatchHeaderSpace(
        HeaderSpace.builder()
            ...
            .setEcns(_ecns)
            .setFragmentOffsets(
                _fragmentOffsets != null ? _fragmentOffsets.getSubRanges() : ImmutableList.of())
            .setIcmpCodes(
  ...
  public String toString() {
    return MoreObjects.toStringHelper(getClass())
        ...
        .add("ecns", _ecns)
        .add("fragmentOffsets", _fragmentOffsets)
